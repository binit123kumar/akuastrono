...
/>
        ...
        <div className="footer-contact-section">
          <h1>Info line - </h1>
          <h1>EMAIL : school.astronomy.aku@gmail.com</h1>
          <h1>Address: Aryabhatta Knowledge University Campus, Mithapur, Patna, Bihar (India)</h1>
        </div>
      </div>
      <div className="Footer-Second-section">
        <div className="Footer-Program-section">
          ...
          <ul>
            <li>
              <Link to={"#"}>
                M. Sc.  in Space Science and Astronomy (SSA)</Link>
            </li>
          </ul>
        </div>
      ...
      <div>
        <iframe
    title="AKU Campus Location Map" // <-- यह line add करें
